        ...
        <div className="container-site max-w-4xl py-12 md:py-16">
          ...
          <div className="article-body mt-8">
            ...
            <p>
              ...
              dalıdır. Akduman Hukuk Bürosu; işçi ve işveren taraflarının
              karşı karşıya geldiği uyuşmazlıklarda dava ve arabuluculuk
              süreçlerinin takibi ile hukuki danışmanlık hizmeti sunmaktadır.
              İşçilik alacakları ve işe iade talepleri; katı sürelere, ispat
              kurallarına ve zorunlu arabuluculuk gibi usul koşullarına bağlı
              olduğundan, sürecin en başından itibaren deneyimli bir avukatla
            ...
            <h2>İş Hukuku Kapsamında Verdiğimiz Hizmetler</h2>
            <p>
            ...
            <h2>İş Davaları Süreci Nasıl İşler?</h2>
            <p>
            ...
            <h3>1. Değerlendirme ve Belge Toplama</h3>
            <p>
              Süreç, iş ilişkisinin ve fesih koşullarının hukuki açıdan
              değerlendirilmesiyle başlamaktadır. Bu aşamada iş sözleşmesi,
              ücret bordroları, fesih bildirimi, mesai kayıtları ve yazışmalar
              gibi belgeler toplanmakta; talep edilebilecek alacak kalemleri
              belirlenmektedir. İş davalarında ispat büyük ölçüde belgeye ve
              tanık beyanına dayandığından bu hazırlık, sürecin ilerleyen
              aşamalarını doğrudan etkilemektedir.
            </p>

            <h3>2. Zorunlu Arabuluculuk Başvurusu</h3>
            <p>
              İşçilik alacakları ve işe iade taleplerinde dava açılmadan önce
              arabulucuya başvurulması bir dava şartıdır. Arabuluculuk
              görüşmelerinde taraflar, bir anlaşma zeminini tarafsız bir
              arabulucu eşliğinde müzakere etmektedir. Anlaşma sağlanırsa
              düzenlenen belge taraflar bakımından bağlayıcı olmakta; anlaşma
              sağlanamazsa son tutanakla birlikte dava yolu açılmaktadır.
            </p>

            <h3>3. Dava Aşaması</h3>
            <p>
              Arabuluculukta anlaşma sağlanamaması hâlinde uyuşmazlık, iş
              mahkemesi önüne taşınmaktadır. Yargılama sırasında tanıklar
              dinlenmekte, işyeri kayıtları ve bordrolar incelenmekte; alacak
              kalemleri genellikle bilirkişi tarafından hazırlanan hesap
              raporuyla belirlenmektedir. Taraflar, rapora karşı itirazlarını
              sunarak hesaplamanın dosya kapsamına uygunluğunun denetlenmesini
              isteyebilmektedir.
            </p>

            <h3>4. Karar ve Kanun Yolları</h3>
            <p>
              Yargılamanın sonunda mahkeme, talepler hakkında kabul veya ret
              yönünde karar vermektedir. Verilen karara karşı kanunda
              öngörülen koşullarla istinaf yoluna, istinaf incelemesinden
              geçen kararlara karşı ise belirli hâllerde temyiz yoluna
