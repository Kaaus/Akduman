 ...
 * Monogram (logo-monogram.png, 485×485 şeffaf) hem açık hem koyu zeminde
 * AYNI dosyadır — altın tonları her iki zeminde de okunur; yalnızca
 * yanındaki metnin rengi `variant`e göre değişir (açık zemin: ink-strong/
 * navy-700 — bronz doktrini <18px bronz metni açık zeminde yasaklar, bkz.
 * CLAUDE.md; koyu zemin: #F4F1EA/bronze-300 — sitede yerleşik "koyu
 * zeminde ivory" tonu, bkz. Hero/CtaBand/SectionHeading).
 * Not: logo-tam.png (yazılı tam logo) header'da KULLANILMIYOR — yatayda
 * çok geniş olduğundan header şeridinde küçük kalıyordu; OG görseli ve
 * ileride başka kullanımlar için projede duruyor (bkz. scripts/generate-og.mjs).
 */
